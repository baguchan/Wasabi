package sugardog.wasabi.client.model;
...
/**
 * TenguIllagerModel - sugardog125
 * Created using Tabula 8.0.0
 */
@OnlyIn(Dist.CLIENT)
public class TenguIllagerModel<T extends TenguIllagerEntity> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
	...
	public TenguIllagerModel(ModelPart p_170688_) {
		this.root = p_170688_;
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition1.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(32, 0).addBox(-2.0F, -3.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -10.0F, 0.0F));
