...
public abstract class WasabiBlockStateProvider extends BlockStateProvider {
	public WasabiBlockStateProvider(DataGenerator generator, ExistingFileHelper fileHelper) {
